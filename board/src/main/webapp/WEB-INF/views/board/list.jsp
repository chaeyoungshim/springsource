          ...
          <div class="col-md-12">
            <div class="col-md-8">
            	...
            	<form action="" method="get" id="searchForm">
            		<input type="hidden" name="pageNum" value="${cri.pageNum}" /> <!-- 얘네도 같이 보내야함 -->
...
<form action="/board/list" id="actionForm">
	...
	- 1) pageDto(pageDto.cri.pageNum) 사용
	- 2) cri(criteria.pageNum(ModelAttribute 가 사용 안된 경우), cri.pageNum)에서 끌어다 사용 
	-->
...
<script>
	...
	let result = '${result}'; /* controller에서 insert 부분에 rttr 로 담아놓은거 가져다쓰기 */
