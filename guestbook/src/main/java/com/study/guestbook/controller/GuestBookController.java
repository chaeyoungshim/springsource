...
public class GuestBookController {
	...
	public void read(long gno,@ModelAttribute("requestDto") PageRequestDTO requestDto, Model model) { //페이지 번호 받기 위해서 넣어주기
	...
	@PostMapping("/modify")
	public String modify(GuestbookDTO updateDto, @ModelAttribute("requestDto") PageRequestDTO requestDto, RedirectAttributes rttr) { //페이지 번호 받기 위해서 넣어주기
		...
		return "redirect:/guestbook/read"; //다시 한 번 폼 보여주기 위해서, 근데 이렇게 하면 53번 줄에 read 부분에서 gno 와 requestDto를 받아야 하기 때문에(안 넣으면 널포인트에셉션 뜸)
	}
